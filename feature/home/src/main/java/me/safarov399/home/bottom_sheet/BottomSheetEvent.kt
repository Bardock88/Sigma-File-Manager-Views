...
sealed class BottomSheetEvent {
    ...
    data class Rename(val oldName: String, val newName: String): BottomSheetEvent()
    data class Copy(val oldPath: String, val newPath: String): BottomSheetEvent()
    data class Move(val oldPath: String, val newPath: String): BottomSheetEvent()
    data class Duplicate(val path: String): BottomSheetEvent()
